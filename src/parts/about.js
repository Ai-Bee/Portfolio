          ...
          <div className="row justify-content-start align-content-center">
            <div className="col-sm-11 col-lg-7 first-col mt-4 pt-4">
              ...
              <h5 className="text-start">
                I'm <span className="name">Iboro,</span>
                <br />
              ...
              <div className="row">
                <div className="col-3">
                  <div className="workArea-mobile">
                    <button
                      onClick={(e) => toggle(e, "one")}
                      className={`css-button-sharp--sky ${
                        current === "one" ? "active" : "inActive"
                      }`}
                    >
                      Kora Technologies
                    </button>
                    <button
                      onClick={(e) => toggle(e, "two")}
                      className={`css-button-sharp--sky ${
                        current === "two" ? "active" : "inActive"
                      }`}
                    >
                      ehealth4everyone
                    </button>
                    <button
                      onClick={(e) => toggle(e, "three")}
                      className={`css-button-sharp--sky ${
                        current === "three" ? "active" : "inActive"
                      }`}
                    >
                      TIIDELab
                    </button>
                    <button
                      onClick={(e) => toggle(e, "four")}
                      className={`css-button-sharp--sky ${
                        current === "four" ? "active" : "inActive"
                      }`}
                    >
                      Sterling Bank
                    </button>
                  ...
                  <div className="tab-content">
                    ...
                    >
                      <ul className="text-start">
                        <li>
                          {" "}
                          Built UI reusable components and complete layouts
                          using React.js and Nuxt.Js
                        </li>
                        <li>
                          Worked with the team to ensure Web app efficiency and
                          scalability
                        </li>
                      </ul>
                    </div>
                    ...
                    >
                      <ul className="text-start">
                        ...
                        <li>
                          Improved website speed through the use of GZip and
                          other strategies
                        </li>
                        <li>
                    ...
                    <div
                      className={`tab-pane fade show ${
                        current === "three" ? "active" : ""
                      }`}
                      role="tabpanel"
                    >
                      <ul className="text-start">
                        <li>
                          Worked alongside a team to build a Dashboard for
              ...
              <div className="row my-3 skills">
                <ul className="col">
                  <li className="py-2 m-1">VUE</li>
                  <li className="py-2 m-1">ECMAScript 2018</li>
                  <li className="py-2 m-1">Javascript</li>
                  <li className="py-2 m-1">REACT</li>
                </ul>
                <ul className="col">
                  <li className="py-2 m-1">NUXT</li>
                  <li className="py-2 m-1">NEXT</li>
                  <li className="py-2 m-1">GIT</li>
                  <li className="py-2 m-1">SCSS</li>
                </ul>
                <ul className="col">
                  <li className="py-2 m-1">Webflow</li>
                  <li className="py-2 m-1">VUETIFY</li>
                  <li className="py-2 m-1">TYPESCRIPT</li>
                  <li className="py-2 m-1">jQuery</li>
                </ul>
              </div>
              <div className="row">
                <div className="col">
